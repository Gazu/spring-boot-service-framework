...
class NotificationTest {
    ...
    void createsImmutableNotificationWithDefaults() {
        ...
        assertThrows(UnsupportedOperationException.class, () -> notification.metadata().put("other", "value"));
    }
    ...
    void rejectsInvalidNotificationContent() {
        assertThrows(
                ...
                () -> Notification.builder().code(" ").build()
        );
        assertThrows(
                IllegalArgumentException.class,
    ...
    void exposesConvenienceFactories() {
        assertEquals(NotificationSeverity.ERROR, Notification.error("E_SERVICE_FRAMEWORK_0001", "error").severity());
        assertEquals(NotificationSeverity.WARNING, Notification.warning("W_SERVICE_FRAMEWORK_0001", "warning").severity());
        assertEquals(NotificationSeverity.INFO, Notification.info("I_SERVICE_FRAMEWORK_0001", "info").severity());
    }
}
