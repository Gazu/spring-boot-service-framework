...
final class ErrorCustomizationPipeline {
     ...
     */
    List<ResolvedErrorCustomizer> resolvedErrorCustomizers() {
     ...
     */
    List<NotificationResponseCustomizer> responseCustomizers() {
