...
import static com.smbtech.serviceframework.starter.errorhandling.customizer.ErrorCustomizationTestFixtures.standardMetadataCustomizer;
...
class SpringMvcErrorHandlingIntegrationTest {
    ...
    void setUp() {
        ...
        ThrowableErrorResolver pipeline =
                ThrowableErrorResolver.composite(
                        List.of(
                                ThrowableErrorResolver.serviceExceptions(),
        ...
        ServiceFrameworkExceptionHandler exceptionHandler =
                new ServiceFrameworkExceptionHandler(
                        ...
                        new ErrorCustomizationPipeline(
                                List.of(standardMetadataCustomizer()),
                                List.of(),
    ...
    void rejectsInvalidHandlerDependenciesAndUnsupportedResolvers() {
        ThrowableErrorResolver pipeline = ThrowableErrorResolver.composite(List.of());
        ...
        assertThrows(
                ...
                () ->
                        new ServiceFrameworkExceptionHandler(
                                pipeline, (NotificationResponseFactory) null));
        assertThrows(
                NullPointerException.class,
