                                    ...
                                    new HttpClientDefinition(
                                            ...
                                            new ErrorHandlingPolicy(
                                                    ...
                                                    errorHandling(client)
                                                            .isIncludeNotificationMetadata(),
                                                    errorHandling(client)
                                                            .getNotificationCodePrefix()),
