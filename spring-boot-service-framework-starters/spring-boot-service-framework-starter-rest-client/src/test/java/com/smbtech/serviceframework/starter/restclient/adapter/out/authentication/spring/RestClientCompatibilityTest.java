        ...
        new ApplicationContextRunner()
                .withConfiguration(
                        AutoConfigurations.of(
                                ...
                                OAuth2RestClientAuthenticationAutoConfiguration.class))
                .withPropertyValues(
                        "smbtech.rest-clients.clients.fixed.base-url=https://ignored.example")
                ...
                .run(
                        context -> {
                            ...
                            assertThat(context.getBean("fixedRestClient", RestClient.class))
                                    .isSameAs(customRegistry.get("fixed"));
                        });
    }
