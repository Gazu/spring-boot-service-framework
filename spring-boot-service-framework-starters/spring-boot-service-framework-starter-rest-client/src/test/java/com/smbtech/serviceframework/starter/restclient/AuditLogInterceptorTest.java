...
class AuditLogInterceptorTest {
    ...
    void auditsRequestAndResponseWithBodiesAndDuration() throws Exception {
        ...
        AuditLogInterceptor interceptor =
                new AuditLogInterceptor(
                        definition(new AuditPolicy(true, true, true, true, true, 12)), sink);
    ...
    void auditsFailureUsingStandardHttpClientResponseException() {
        ...
        AuditLogInterceptor interceptor =
                new AuditLogInterceptor(
                        definition(new AuditPolicy(true, true, true, true, true, 16)), sink);
        ...
        assertThat(sink.failure.get())
                .satisfies(
                        event -> {
                            ...
                            assertThat(event.responseBody())
                                    .isEqualTo("{\"message\":\"down...[truncated]");
                            assertThat(event.exceptionType())
