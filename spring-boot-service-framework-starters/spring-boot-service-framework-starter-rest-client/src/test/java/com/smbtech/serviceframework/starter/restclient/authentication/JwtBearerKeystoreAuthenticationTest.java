...
class JwtBearerKeystoreAuthenticationTest {
    ...
    void createsSignedJwtBearerAssertionFromConfiguredKeyStore() throws Exception {
        ...
        new ApplicationContextRunner()
                ...
                .withBean(ClientRegistrationRepository.class, () -> jwtBearerRegistrationRepository(endpoint.url()))
                .withPropertyValues(
                ...
                .run(context -> {
                    String token = context.getBean(AccessTokenProvider.class)
                    ...
                    assertThat(endpoint.formValues()).containsEntry("scope", "payments.write");
    ...
    void createsSignedJwtBearerAssertionFromBase64KeyStore() throws Exception {
        ...
        new ApplicationContextRunner()
                ...
                .withBean(ClientRegistrationRepository.class, () -> jwtBearerRegistrationRepository(endpoint.url()))
                .withPropertyValues(
                        "smbtech.rest-clients.authentication.key-stores.auth-key.base64=" + keyStoreBase64,
                        "smbtech.rest-clients.authentication.key-stores.auth-key.type=PKCS12",
                        "smbtech.rest-clients.authentication.key-stores.auth-key.password-ref=keystore-password",
                        "smbtech.rest-clients.authentication.key-stores.auth-key.key-alias=auth",
                        "smbtech.rest-clients.authentication.key-stores.auth-key.key-password-ref=key-password",
    ...
    @Test
    void createsSignedJwtBearerAssertionFromJksWithDifferentStorePasswordAndKeyPassword() throws Exception {
    ...
    private boolean verify(String assertion, Path keyStorePath, String keyStoreType, String storePassword) throws Exception {
    ...
    private Certificate certificate(Path keyStorePath, String keyStoreType, String storePassword) throws Exception {
