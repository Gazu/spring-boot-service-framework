...
class RestClientCustomizerTest {
    ...
    void appliesCustomizersWhenRestClientIsCreated() {
        ...
        new ApplicationContextRunner()
                ...
                .withBean(RestClientBuilderCustomizer.class, () -> (definition, builder) -> {
                    restClientCustomized.set(definition.name());
                    builder.defaultHeader("X-Customized-By", "spring-boot-service-framework-test");
                })
                .withBean(ApacheHttpClientBuilderCustomizer.class, () -> (definition, builder) -> {
                    apacheCustomized.set(definition.name());
                    builder.setUserAgent("spring-boot-service-framework-test");
                })
                .withBean(ClientHttpRequestFactoryCustomizer.class, () -> (definition, requestFactory) ->
                ...
                .run(context -> {
                    ...
                    assertThat(requestFactoryType).hasValue(HttpComponentsClientHttpRequestFactory.class);
                });
    }
}
