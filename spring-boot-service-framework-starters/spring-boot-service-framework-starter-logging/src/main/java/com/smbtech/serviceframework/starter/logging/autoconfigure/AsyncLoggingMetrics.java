...
final class AsyncLoggingMetrics implements MeterBinder {

    /** Configured asynchronous queue capacity. */
    static final String QUEUE_CAPACITY_METRIC_NAME = "smbtech.logging.async.queue.capacity";

    /** Current number of queued logging events. */
    static final String QUEUE_DEPTH_METRIC_NAME = "smbtech.logging.async.queue.depth";

    /** Current remaining asynchronous queue capacity. */
    static final String QUEUE_REMAINING_METRIC_NAME = "smbtech.logging.async.queue.remaining";

    /** Number of discarded logging events, tagged by a bounded reason. */
    static final String DISCARDED_EVENTS_METRIC_NAME = "smbtech.logging.async.events.discarded";

    /** Number of critical events delivered through synchronous fallback. */
    static final String CRITICAL_FALLBACKS_METRIC_NAME = "smbtech.logging.async.critical.fallbacks";

    /** Producer wait count and cumulative duration observed on a full queue. */
    static final String PRODUCER_BLOCK_METRIC_NAME = "smbtech.logging.async.producer.block";

    /** Whether the asynchronous appender currently accepts events. */
    static final String ACCEPTING_EVENTS_METRIC_NAME = "smbtech.logging.async.accepting";

    /** Number of events rejected after shutdown admission closed. */
    static final String REJECTED_EVENTS_METRIC_NAME = "smbtech.logging.async.events.rejected";

    /** Shutdown count and cumulative duration. */
    static final String SHUTDOWN_METRIC_NAME = "smbtech.logging.async.shutdown";

    /** Number of shutdown attempts that exceeded the flush timeout. */
    static final String SHUTDOWN_TIMEOUTS_METRIC_NAME = "smbtech.logging.async.shutdown.timeouts";

    /** Events left in the queue when the last shutdown attempt returned. */
    static final String SHUTDOWN_PENDING_METRIC_NAME = "smbtech.logging.async.shutdown.pending";
