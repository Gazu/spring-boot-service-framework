...
import com.smbtech.serviceframework.starter.actuator.adapter.out.integration.ErrorHandlingModuleInfoProvider;
import com.smbtech.serviceframework.starter.actuator.adapter.out.integration.LoggingModuleInfoProvider;
import com.smbtech.serviceframework.starter.actuator.adapter.out.integration.MockModuleInfoProvider;
import com.smbtech.serviceframework.starter.actuator.adapter.out.integration.RestClientDiagnosticProbe;
import com.smbtech.serviceframework.starter.actuator.adapter.out.integration.RestClientModuleInfoProvider;
